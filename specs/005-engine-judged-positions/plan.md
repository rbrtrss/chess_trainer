...
| **The constitution does not contemplate an engine** | A major dependency arriving without the amendment procedure the document asks for | D11 recommends a MINOR amendment and the plan proceeds no further on it. It is the owner's decision, not the implementation's |
