...
| **Materialised**: the bar had no room for the disclosure | D6 assumed a two-line footer was free; at 72px and above the Start button leaves the screen on a 400×900 phone showing the resume offer | Bar cut to one line at 56, disclosure moved to a sheet (D6a). Costs SC-002 as literally worded — recorded in [tasks.md](./tasks.md#what-was-done-and-what-was-not), not reinterpreted. |
